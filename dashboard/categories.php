...
?>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($category)) {
      $catErro =  "<div class='alert alert-danger'>" . "Please fill in the field below" . "</div>";
    } else {
      $query = "INSERT INTO categories(categoryName) VALUES('$category')";
      $result = mysqli_query($con, $query);
      if (isset($result)) {
        $catSuccess =  "<div class='alert alert-success'>" . "Category added successfully." . "</div>";
      }
    }
  }
      ...
      <div class="add-cat">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
          <div class="form-group">
            <label for="cat">Add a category:</label>
          ...
          <tbody>
            ...
            ?>
              ...
              <tr>
                ...
                <td>
                  <a href="edit-cat.php?id=<?php echo $row['id']; ?>" class="custom-btn">Edit</a>
                  <a href="categories.php?id=<?php echo $row['id']; ?>" class="custom-btn confirm">Delete</a>
                </td>
              </tr>
            <?php
            }
